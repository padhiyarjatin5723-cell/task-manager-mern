...
function TaskCard({ task, handleDelete }) {
  ...
  return (
    ...
    <motion.div
      ...
      className="group rounded-[30px] border border-slate-200 bg-white/80 backdrop-blur-xl p-7 shadow-xl hover:shadow-indigo-300/30"
    ...
    >
      ...
      <div className="mt-7 flex items-center text-slate-500">
